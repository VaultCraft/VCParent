...
package net.vaultcraft.vcutils.vote.net;
...
import net.vaultcraft.vcutils.vote.crypto.RSA;
import net.vaultcraft.vcutils.vote.model.Vote;
import net.vaultcraft.vcutils.vote.model.VoteListener;
import net.vaultcraft.vcutils.vote.model.VotifierEvent;
    ...
    public void run() {
        ...
        while (running) {
            try {
                ...
                Bukkit.getScheduler()
                        .scheduleSyncDelayedTask(VCUtils.getInstance(), new Runnable() {
                            public void run() {
