...
public class StaticHologramCraftEntityHorse extends CraftHorse {

	public StaticHologramCraftEntityHorse(CraftServer server, StaticHologramNMSEntityHorse entity) {
		super(server, entity);
	}
	...
	public void remove() {
		...
		StaticHologramNMSEntityHorse horse = (StaticHologramNMSEntityHorse) getHandle();
		if (horse.has_despawned) {
			entity.dead = true;
		}
	}
